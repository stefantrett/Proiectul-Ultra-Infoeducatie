...
int main(int argc, const char *argv[]) {
	...
	// check if we are running on Galileo or Edison
	...
	//read button value until it's pressed
	//when it's pressed the program starts to run
	...
	//the tone stop after the photo will have taken
	...
	case HAPPY:
		...
		system("echo 'happy' >> emotions.txt");
		break;
	case ANGRY:
		...
		system("echo 'angry' >> emotions.txt");
		break;
	case AMAZED:
		...
		system("echo 'amazed' >> emotions.txt");
		break;
	}
